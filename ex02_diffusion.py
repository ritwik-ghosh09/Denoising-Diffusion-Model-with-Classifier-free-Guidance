...
class Diffusion:
    ...
    def p_sample(self, model, x, t, t_index, y=None, p_uncond=None, cfg_scale=None):
        ...
        if t_index == 0:
            ...
            return model_mean + (torch.sqrt(posterior_variance_t) * z_noise)  # TODO (2.2): Returns the image at timestep t-1 -> x_t-1.
    ...
    def sample(self, model, image_size, batch_size=16, channels=3, y=None, p_uncond=None, cfg_scale=None):     #samples from individual batches
        ...
        return np.array(x_gen)   # TODO (2.2): Returns batches of generated images throughout the reverse timesteps
